...
item_aspect_score = defaultdict(lambda: defaultdict(int))
...
with open(review_path, "r", encoding="utf-8") as f:
    for idx, line in enumerate(f):
        ...
        for key, count in pred.items():
            ...
            item_aspect_score[item][aspect] += count
...
save_score_path = r"D:\workspace\dataset\aspect\dm5\12.item_aspect_total.json"

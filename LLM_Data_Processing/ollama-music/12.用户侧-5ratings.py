...
user_aspect_sent = defaultdict(lambda:defaultdict(lambda: defaultdict(lambda: {"positive": 0, "neutral": 0, "negative": 0})))

# user -> aspect -> total_count
user_aspect_total = defaultdict(lambda:defaultdict(lambda: defaultdict(int)))
...
with open(review_path, "r", encoding="utf-8") as f:
    for idx, line in enumerate(f):
        ...
        for key, count in pred.items():
            ...
            user_aspect_sent[rating][user][aspect][sentiment] += count
            user_aspect_total[rating][user][aspect] += count


# ==== 6. 可选：保存结果 ====
save_user_aspect_sent = r"D:\workspace\dataset\aspect\dm5\12.user_aspect_sentiment_5ratings.json"
save_user_aspect_total = r"D:\workspace\dataset\aspect\dm5\12.user_aspect_total_5ratings.json"

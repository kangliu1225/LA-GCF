...
with open(review_path, "r", encoding="utf-8") as f:
    for idx, line in enumerate(f):
        ...
        for key, count in pred.items():
            ...
            #     user_aspect_total[user][aspect] += -1
            # if sentiment=='positive':
            #     user_aspect_total[user][aspect] += 1

for user, aspects in user_aspect_sent.items():
    for aspect, senti_count in aspects.items():
        score = senti_count["positive"] - senti_count["negative"]
        user_aspect_total[user][aspect] = score
# ==== 4. 统计所有出现过的 aspect ====
all_aspects = set()
...
# ==== 6. 可选：保存结果 ====
# save_user_aspect_sent = r"D:\workspace\dataset\aspect\music\12.user_aspect_sentiment.json"
save_user_aspect_total = r"D:\workspace\dataset\aspect\dm5\12.user_aspect_total_sent.json"
